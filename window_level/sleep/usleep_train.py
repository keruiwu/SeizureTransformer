...
from usleep_model import USleep
...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def forward(self, x):
        x = temporal_interpolation(x, 128*30)
        # print('x', x.shape)
...
fold = 0
for fold in range(5):
    train_dataset = torchvision.datasets.DatasetFolder(root="/home/wuk9/Seizure/EEGPT-main/datasets/downstream/sleep_edf_full/TrainFold", loader=lambda x: torch.load(x),  extensions=['.pt'])
    valid_dataset = torchvision.datasets.DatasetFolder(root="/home/wuk9/Seizure/EEGPT-main/datasets/downstream/sleep_edf_full/TestFold", loader=lambda x: torch.load(x), extensions=[f'.pt'])
